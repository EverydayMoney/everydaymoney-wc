...
class WC_Everydaymoney_Gateway extends WC_Payment_Gateway {
     ...
     * This is the crucial function for making the gateway appear at checkout.
     *
     * @return bool
     */
    public function is_available() {
        // Start with the parent check, which primarily looks at if the gateway is enabled.
        ...
        // Check for API credentials. If they are missing, do not show the gateway.
        ...
        // If all checks pass, the gateway is available.
        return true;
    }
    ...
    public function handle_webhook() {
        if ( ! isset($this->logger) ) { return; } // Add a safeguard
